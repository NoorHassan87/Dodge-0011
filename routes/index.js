...
// Get dodgeGarage page
router.get('/dodgeGarage', function (req, res) {
    res.render('dodgeGarage');
});
...
router.put('/api/car', function (req, res) {
    var edit = req.param('car')
    Dodge.findByIdAndUpdate(edit._id, edit).then(function () {
        res.json({
            isSuccess: true,
            message: "Car Updated!"
        })
